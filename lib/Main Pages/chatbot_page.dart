...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<String> askQuestion(String message) async {
    final url = Uri.parse('http://20.28.67.10:3000/chatbot/ask-question');
  ...
  void getCure(plantName, diseaseName) async {
    ...
    final url = Uri.parse('http://20.28.67.10:3000/chatbot/get-cure');
    final res = await http.post(
      url,
      headers: <String, String>{
        'Content-Type': 'application/json',
  ...
  void clearHistory() async {
    final url = Uri.parse('http://20.28.67.10:3000/chatbot/clear-history');
    final res = await http.post(
      url,
      headers: <String, String>{
        'Content-Type': 'application/json',
